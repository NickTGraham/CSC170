  ...
  <article>
    ...
    <p><em>This bill ... shut down whole websites. Essentially, it stopped Americans from communicating entirely with certain groups....
      ...
      <ul>
        ...
        <li>Gruber, John; Swartz, Aaron (December 2004), Markdown definition, Daring Fireball.</li>
        <li>Swartz, Aaron (July 2008). "Guerilla Open Access Manifesto"</li>
        <li>Swartz, Aaron (August 2008). "Intellectual property and software". Journal of Software Technology.</li>
        <li>Swartz, Aaron; James Hendler (2009). Building progammable Web sites. S.F.: Morgan & Claypool. ISBN 1-59829-920-4.</li>
        <li>Swartz, Aaron (Interviewee) (2009?). We can change the world (Video). YouTube.</li>
      ...
      <table>
        ...
        <tr>
          <td>Central Avenue Synagogue in Highland Park, Illinois</td>
        ...
        <tr>
          ...
          <td>Stinebrickner-Kauffman, Open Source advocate Doc Searls, Creative Commons' Glenn Otis Brown, journalist Quinn Norton, Roy Singham of ThoughtWorks, and David Segal of Demand Progress</td>
        </tr>
        <tr>
          <td>Internet Archive</td>
          <td>January 24, 2013</td>
          <td>Stinebrickner-Kauffman, Alex Stamos, Brewster Kahle and Carl Malamud</td>
        </tr>
        <tr>
          <td>Cannon House Office Building on Capitol Hill</td>
          <td>February 4, 2013</td>
          <td>Senator Ron Wyden and Representatives Darrell Issa, Alan Grayson and Jared Polis.</td>
        </tr>
        <tr>
          <td>MIT Media Lab</td>
          <td>March 12, 2013</td>
